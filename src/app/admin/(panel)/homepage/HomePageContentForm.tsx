  ...
  return (
    <form action={formAction} className="mt-6 max-w-2xl space-y-6">
      <div>
        ...
        {initialHeroUrl ? (
          <div className="relative mt-3 aspect-[3/1] w-full max-w-xl overflow-hidden rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)]">
            {showPreview ? (
              <Image
                src={initialHeroUrl}
                alt=""
              ...
              <img src={initialHeroUrl} alt="" className="h-full w-full object-cover" />
            )}
          </div>
        ) : (
