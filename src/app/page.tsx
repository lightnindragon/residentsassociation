      ...
      <section className="border-b border-[var(--color-border)] bg-[var(--color-card)] py-16 sm:py-24">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
          ...
          <p className="mt-6 text-lg leading-relaxed text-[var(--foreground)]">
            Your community hub for local news, events and discussion. Stay
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-2">
          <Link href="/news">
            <Card className="h-full transition-shadow hover:shadow-md">
              ...
              <CardContent>
                Read the latest community news and announcements from the
                association.
              </CardContent>
            </Card>
          </Link>
          <Link href="/forum">
            <Card className="h-full transition-shadow hover:shadow-md">
              ...
              <CardContent>
                Join the conversation. Sign in to view and take part in
          ...
          <Link href="/contact">
            <Card className="h-full transition-shadow hover:shadow-md">
              ...
              <CardContent>
                Get in touch with the committee or send a message to the
                association.
              </CardContent>
            </Card>
          </Link>
